...
This repository hosts MCP Apps demo projects backing a Zenn article series, built on top of the Ralph Matsuo docs-first workflow template.
...
- [`prd-article-4-llm-council`](./docs/prds/prd-article-4-llm-council/prd.md) — Article 4: ChatGPT 主催の LLM 合議 MCP App (Article 3 の発展、Synthesizer 型 3 ラウンド合議)

Article outlines are stored in [`docs/references/article-outlines/`](./docs/references/article-outlines/).

See [`docs/roadmap.md`](./docs/roadmap.md) for the article plan and [`docs/references/MCP Apps/`](./docs/references/MCP%20Apps/) for reference material gathered on MCP Apps itself.

---

## Ralph Matsuo (template foundation)
